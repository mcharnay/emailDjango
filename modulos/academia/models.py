...
class Carrera(models.Model):
    ...
    #toString para darle formato a como se vea en el admin
    def __str__(self):
...
class Estudiante(models.Model):
    ...
    #darle format, cosa que se guarde como nombre completo
...
class Curso(models.Model):
    ...
    #toString, formateado para que se vea así al buscarlo y no x ID
    def __str__(self):
        txt = "{0} ({1} / Docente : {2})"
